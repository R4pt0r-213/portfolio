      ...
      <div className="space-y-14">
        {items.map((item, index) => (
          <div key={index} className="relative flex items-center gap-8">
            ...
            <div
              className={clsx(
                "group relative flex-1 overflow-hidden rounded-3xl",
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-2 text-2xl font-bold text-red-50">
                  {item.title}
                </h3>
              ...
              <span
                aria-hidden
                className="absolute bottom-0 left-1/2 h-px w-24 -translate-x-1/2 bg-gradient-to-r from-transparent via-red-200/80 to-transparent opacity-70"
              />
            </div>
          </div>
        ))}
